...
const GENERIC_FAQS: { category: string; question: string; answer: string }[] = [
  {
    category: 'Chính sách',
    question: 'Khách sạn có cho mang theo thú cưng không?',
    answer: 'Rất tiếc, khách sạn không nhận thú cưng, trừ chó dẫn đường hỗ trợ người khuyết tật.',
  },
  {
    category: 'Chính sách',
    question: 'Chính sách hủy phòng như thế nào?',
    answer: 'Hủy miễn phí nếu báo trước 48 giờ so với giờ nhận phòng; trong vòng 48 giờ sẽ bị thu phí 1 đêm đầu.',
  },
  {
    category: 'Chính sách',
    question: 'Khách sạn có cho hút thuốc trong phòng không?',
    answer: 'Tất cả phòng đều cấm hút thuốc. Có khu vực hút thuốc riêng ngoài trời.',
  },
  {
    category: 'Chính sách',
    question: 'Trẻ em ở cùng có tính phí không?',
    answer: 'Trẻ dưới 6 tuổi ngủ ghép giường với bố mẹ được miễn phí; từ 6 tuổi tính như người lớn hoặc phụ thu giường phụ.',
  },
  {
    category: 'Chính sách',
    question: 'Nhận phòng cần giấy tờ gì?',
    answer: 'Khách vui lòng xuất trình CCCD/CMND hoặc hộ chiếu còn hiệu lực khi nhận phòng.',
  },
  {
    category: 'Chính sách',
    question: 'Giờ nhận và trả phòng là mấy giờ?',
    answer: 'Nhận phòng từ 14:00, trả phòng trước 12:00.',
  },
  {
    category: 'Chính sách',
    question: 'Nhận phòng sớm hoặc trả phòng muộn được không?',
    answer: 'Tuỳ tình trạng phòng. Trả phòng muộn sau 12:00 có thể phụ thu; vui lòng hỏi lễ tân.',
  },
  {
    category: 'Tiện ích',
    question: 'Khách sạn có WiFi miễn phí không?',
    answer: 'Có WiFi miễn phí tốc độ cao ở toàn bộ khu vực và trong phòng.',
  },
  {
    category: 'Tiện ích',
    question: 'Hồ bơi mở cửa mấy giờ?',
    answer: 'Hồ bơi mở từ 6:00 đến 21:00 hằng ngày (nếu khách sạn có hồ bơi).',
  },
  { category: 'Tiện ích', question: 'Bữa sáng phục vụ mấy giờ?', answer: 'Bữa sáng buffet phục vụ từ 6:30 đến 9:30.' },
  {
    ...
    answer: 'Có bãi đậu xe cho khách lưu trú, ưu tiên theo chỗ trống.',
  },
  {
    category: 'Tiện ích',
    question: 'Có thể gửi hành lý trước hoặc sau giờ nhận phòng không?',
    answer: 'Có, lễ tân nhận giữ hành lý miễn phí trước khi nhận phòng và sau khi trả phòng.',
  },
  {
    category: 'Thanh toán',
    question: 'Khách sạn nhận thanh toán bằng hình thức nào?',
    answer: 'Nhận thanh toán online qua VNPay, chuyển khoản quét QR qua SePay, và tiền mặt tại quầy lễ tân.',
  },
  {
    category: 'Thanh toán',
    question: 'Khách sạn có xuất hóa đơn VAT không?',
    answer: 'Có, hoá đơn được phát hành khi trả phòng và đã tách riêng phần thuế.',
  },
  {
    category: 'Thanh toán',
    question: 'Tôi hủy phòng đã trả tiền thì được hoàn lại không?',
    answer:
      'Có. Hoàn 100% nếu hủy trước 48 giờ; trong 48 giờ giữ lại 1 đêm đầu. Yêu cầu hoàn tiền cần khách sạn duyệt trước khi chuyển khoản.',
  },
];
...
interface SeedHotel {
  ...
  nearby: {
    ...
    distance: number;
    transportType: NearbyTransportType;
...
const HOTELS: SeedHotel[] = [
  {
    ...
    representative: {
      fullName: 'Trần Minh Đức',
      role: 'owner',
      idNumber: '048201001234',
      phone: '0901000001',
      address: '12 Võ Nguyên Giáp, Sơn Trà, Đà Nẵng',
    },
    payout: {
      accountHolder: 'TRAN MINH DUC',
    ...
    roomTypes: [
      {
        ...
        description: 'Phòng 32m² với ban công riêng nhìn thẳng ra biển Mỹ Khê, giường King và bồn tắm nằm.',
        maxOccupancy: 2,
        maxAdults: 2,
        maxChildren: 1,
        basePrice: 1_500_000,
      ...
      {
        name: 'Suite Gia Đình',
        description: 'Suite 55m² hai phòng ngủ riêng biệt, phù hợp gia đình 4 người, có khu bếp nhỏ và phòng khách.',
        maxOccupancy: 4,
        maxAdults: 2,
        maxChildren: 2,
        basePrice: 2_600_000,
        ...
        beds: [
          ...
          { bedType: 'single', quantity: 2 },
        ],
        amenities: ['Điều hoà', 'TV màn hình phẳng', 'Minibar', 'Ban công', 'Két an toàn', 'Máy pha cà phê', 'Bồn tắm'],
        images: ['suite-01', 'suite-02'],
      },
      {
        name: 'Standard Hướng Vườn',
        description: 'Phòng 26m² nhìn ra vườn nhiệt đới, yên tĩnh, giường Queen.',
        maxOccupancy: 2,
        maxAdults: 2,
        maxChildren: 0,
        basePrice: 900_000,
    ...
    policies: [
      {
        ...
        description: 'Huỷ miễn phí trước 48 giờ so với giờ nhận phòng. Huỷ muộn hơn sẽ bị giữ lại tiền một đêm đầu.',
        important: true,
      },
      {
        title: 'Giờ nhận / trả phòng',
        description: 'Nhận phòng từ 14:00, trả phòng trước 12:00. Trả phòng muộn có thể phụ thu.',
      },
      {
        title: 'Đặt cọc',
        description: 'Đặt cọc minibar 200.000đ khi nhận phòng, hoàn lại đầy đủ lúc trả phòng nếu không phát sinh.',
      },
...

  {
    ...
    representative: {
      ...
      idNumber: '079198002345',
      phone: '0901000002',
      address: '45 Lê Lợi, Quận 1, TP.HCM',
    },
    payout: {
      accountHolder: 'NGUYEN THU HA',
      bankName: 'Techcombank',
      accountNumber: '19036789012345',
      bankBranch: 'CN Sài Gòn',
    },
    ...
    roomTypes: [
      {
        name: 'Superior',
        description: 'Phòng 24m² nhìn ra thành phố, bàn làm việc rộng, phù hợp khách công tác.',
        maxOccupancy: 2,
        maxAdults: 2,
        maxChildren: 0,
        basePrice: 850_000,
      ...
      {
        name: 'Deluxe Thành Phố',
        description: 'Phòng 30m² tầng cao, cửa sổ kính lớn nhìn toàn cảnh trung tâm Quận 1.',
        maxOccupancy: 3,
        maxAdults: 2,
        maxChildren: 1,
        basePrice: 1_200_000,
      ...
      },
      {
        ...
        description: 'Suite 48m² tầng 16 có phòng khách riêng và quyền vào phòng chờ Executive.',
        maxOccupancy: 3,
        maxAdults: 3,
        maxChildren: 0,
        basePrice: 2_200_000,
    ...
    policies: [
      {
        title: 'Chính sách huỷ phòng',
        description: 'Huỷ miễn phí trước 24 giờ so với giờ nhận phòng. Huỷ muộn hơn sẽ bị giữ lại tiền một đêm đầu.',
        important: true,
      },
...

  {
    ...
    roomTypes: [
      {
        name: 'Standard Phố Cổ',
        description: 'Phòng 20m² gọn gàng, cửa sổ nhìn ra phố Hàng Bạc nhộn nhịp.',
        maxOccupancy: 2,
        maxAdults: 2,
        maxChildren: 0,
        basePrice: 650_000,
      ...
      },
      {
        ...
        description: 'Phòng 26m² có ban công nhỏ nhìn xuống phố cổ, sáng và thoáng.',
        maxOccupancy: 2,
        maxAdults: 2,
        maxChildren: 1,
        basePrice: 950_000,
    ...
    policies: [
      ...
      {
        title: 'Tiếng ồn khu phố cổ',
        description: 'Khách sạn nằm giữa khu phố đi bộ cuối tuần, có thể ồn tới khuya thứ Sáu và thứ Bảy.',
        important: true,
      },
      { title: 'Giờ nhận / trả phòng', description: 'Nhận phòng từ 14:00, trả phòng trước 12:00.' },
    ],
...

  {
    ...
    representative: {
      fullName: 'Phạm Hải Yến',
      role: 'director',
      idNumber: '056200004567',
      phone: '0901000004',
      address: '90 Trần Phú, Nha Trang, Khánh Hoà',
    },
    ...
    roomTypes: [
      {
        name: 'Deluxe Hướng Vịnh',
        description: 'Phòng 30m² ban công nhìn thẳng ra vịnh Nha Trang, giường King.',
        maxOccupancy: 2,
        maxAdults: 2,
        maxChildren: 1,
        basePrice: 1_350_000,
      ...
      {
        name: 'Bungalow Vườn Dừa',
        description: 'Bungalow riêng 40m² giữa vườn dừa, hiên riêng và lối đi thẳng ra hồ bơi.',
        maxOccupancy: 3,
        maxAdults: 2,
        maxChildren: 1,
        basePrice: 1_900_000,
    ...
    policies: [
      {
        title: 'Chính sách huỷ phòng',
        description: 'Huỷ miễn phí trước 72 giờ so với giờ nhận phòng. Huỷ muộn hơn sẽ mất toàn bộ tiền phòng.',
        important: true,
      },
      {
        title: 'Phí resort',
        description: 'Phí resort 80.000đ/đêm đã gồm khăn tắm biển, ghế bãi biển và lớp yoga buổi sáng.',
        important: true,
      },
      { title: 'Giờ nhận / trả phòng', description: 'Nhận phòng từ 14:00, trả phòng trước 12:00.' },
    ],
...
const main = async (): Promise<void> => {
  ...
  for (const acc of ACCOUNTS) {
    const user = await prisma.user.create({
      data: {
        ...
        profile: {
          create: { nationality: 'Vietnamese', preferredLanguage: 'vi', preferredCurrency: 'VND', marketingOptIn: false },
        },
      },
    });
  ...
  for (const h of HOTELS) {
    ...
    const hotel = await prisma.hotel.create({
      data: {
        ...
        contacts: {
          create: [
            { contactType: 'general', name: 'Lễ tân', phone: h.phone, phoneType: 'voice', email: h.email },
            {
              ...
              name: 'Phòng kế toán',
              email: `invoice-${h.city.toLowerCase().replace(/\s/g, '')}@smartstay.ai`,
            },
          ],
        },
        nearbyPlaces: {
        ...
        // Schema đã gộp charges + policies vào HotelPolicy (mỗi item BẮT BUỘC có
        // policyType). Free-text policies (title/important) không còn trong schema;
        // chính sách huỷ THẬT đọc từ settings.cancellation ở trên.
        policies: {
          create: h.charges.map((c) => ({
            policyType: c.chargeType, // 'tax' | 'fee'... khớp enum HotelPolicyType
            description: c.name,
            amount: c.amount,
            isPercentage: c.isPercentage,
            // Tính theo % thì tần suất vô nghĩa — lưu null cho khỏi hiểu nhầm.
    ...
    const licenses: { licenseType: LicenseType; number: string; docType: VerificationDocumentType }[] = [
      { licenseType: 'business_license', number: h.businessRegistrationNumber, docType: 'business_license' },
      {
        ...
        number: `GP-${h.businessRegistrationNumber.slice(-4)}`,
    ...
    await prisma.faqKnowledgeBase.createMany({
      data: [
        ...GENERIC_FAQS.map((f) => ({ hotelId: hotel.id, ...f })),
        {
          ...
          answer: `Khách sạn có: ${h.amenities.join(', ')}.`,
        },
        {
          hotelId: hotel.id,
          category: 'Phòng',
          question: 'Khách sạn có những loại phòng nào?',
          answer: `Các loại phòng: ${h.roomTypes.map((r) => r.name).join(', ')}.`,
        },
        {
          hotelId: hotel.id,
          category: 'Phòng',
        ...
        },
        {
          ...
          answer: `${h.address}, ${h.district}, ${h.city}.`,
        },
        {
          hotelId: hotel.id,
          category: 'Thông tin',
          question: 'Khách sạn được xếp hạng mấy sao?',
          answer: `Khách sạn đạt chuẩn ${h.starRating} sao.`,
        },
      ],
    });
    ...
    console.log(
      `  ✓ ${h.name.padEnd(34)} ${h.roomTypes.length} loại phòng, ${totalRooms} phòng, ${DOCUMENT_TYPES.length} giấy tờ`
    );
  }
  ...
  await prisma.pricingRule.create({
    data: {
      hotelId: danang.id,
      roomTypeId: oceanDanang.id,
      name: 'Phụ thu cuối tuần — Deluxe Hướng Biển',
      ruleType: 'weekend' as PricingRuleType,
  ...
  await prisma.pricingRule.create({
    data: {
      hotelId: nhatrang.id,
      name: 'Cao điểm hè — toàn khách sạn',
  ...
  await prisma.pricingRule.create({
    data: {
      hotelId: saigon.id,
      name: 'Đặt sớm giảm 15%',
      ruleType: 'early_bird' as PricingRuleType,
      startDate: daysFromNow(0),
  ...
  await prisma.pricingRule.create({
    data: {
      hotelId: hanoi.id,
      name: 'Phụ thu khi gần kín phòng',
      ruleType: 'occupancy' as PricingRuleType,
      startDate: daysFromNow(0),
      endDate: daysFromNow(90),
      dayOfWeek: [],
  ...
  console.log(
    `  ✓ ${HOLIDAYS.length} dịp lễ × ${createdHotels.length} khách sạn = ${
      HOLIDAYS.length * createdHotels.length
    } rule phụ thu lễ`
  );
  ...
  await prisma.roomAvailability.create({
    data: {
      ...
      hotelId: danang.id,
      date: daysFromNow(10),
      totalRooms: oceanDanang.roomCount,
      bookedRooms: 0,
  ...
  const money = (hotel: (typeof createdHotels)[number], basePrice: number, nights: number, guests: number) => {
    ...
    for (const c of hotel.charges) {
      const v = c.isPercentage
        ...
        : c.amount *
          { per_stay: 1, per_night: nights, per_person: guests, per_person_per_night: guests * nights }[
            c.chargeFrequency ?? 'per_stay'
          ];
    ...
    return {
      ...
      totalAmount: subtotal + Math.round(tax) + Math.round(fee),
    };
  };
  ...
  const BOOKINGS: SeedBooking[] = [
    ...
    },
    {
      ...
      review: {
        by: customer3.id,
        rating: 5,
        title: 'Resort tuyệt vời',
        content: 'Phòng rộng, ban công nhìn thẳng ra biển. Nhân viên nhiệt tình, bữa sáng nhiều món. Sẽ quay lại.',
      },
    },
    {
      code: 'BKSEED005',
      ...
      review: {
        ...
        rating: 4,
        title: 'Đáng tiền',
        content: 'Vị trí sát biển rất tiện. Hồ bơi hơi đông vào buổi chiều nhưng nhìn chung rất ổn.',
      },
    },
    {
      code: 'BKSEED006',
    ...
    // Sài Gòn
    {
      ...
      review: {
        by: customer1.id,
        rating: 5,
        title: 'Ngay trung tâm',
        content: 'Đi bộ ra Bến Thành 5 phút. Phòng sạch, cách âm tốt dù ở mặt đường.',
      },
    },
    {
      code: 'BKSEED008',
    ...
    // Hà Nội
    {
      ...
      review: {
        by: customer3.id,
        rating: 4,
        title: 'Vị trí đẹp giữa phố cổ',
        content: 'Ban công nhìn xuống phố rất thích. Cuối tuần hơi ồn đúng như khách sạn đã báo trước.',
      },
    },
    {
      code: 'BKSEED010',
    ...
    // Nha Trang
    {
      ...
      review: {
        by: customer2.id,
        rating: 5,
        title: 'Bungalow rất riêng tư',
        content: 'Ở giữa vườn dừa, sáng ra hồ bơi vài bước chân. Phí resort đáng giá vì gồm cả ghế bãi biển.',
      },
    },
    {
      code: 'BKSEED012',
    ...
    if (b.voucher) {
      await prisma.bookingVoucher.create({
        data: {
          ...
          voucherCode: b.voucher,
          qrData: `SMARTSTAY|${b.voucher}|${b.code}`,
          expiresAt: checkOut,
        },
      });
    }
    ...
    if (b.paid) {
      ...
      await prisma.platformCommission.create({
        data: {
          ...
          partnerId: (
            await prisma.hotel.findUniqueOrThrow({ where: { id: b.hotel.id }, select: { partnerId: true } })
          ).partnerId,
          commissionRate: rate,
          commissionAmount,
    ...
    if (b.review) {
      await prisma.review.create({
        data: {
          ...
          hotelId: b.hotel.id,
          overallRating: b.review.rating,
          cleanlinessRating: b.review.rating,
          serviceRating: b.review.rating,
          locationRating: 5,
          valueRating: b.review.rating,
  ...
  // ----- Ví khách (TẠM TẮT) -----
  // Schema hiện tại chỉ có `Wallet` cho KHÁCH SẠN (hotelId unique, KHÔNG có
  // customerId) → không tồn tại model ví khách hàng. Bỏ qua seed ví customer
  // để seed chạy trọn.
  // TODO(BE): nếu payWithWallet cho khách là tính năng thật, cần thêm model ví
  //           khách hàng (migration) rồi bật lại block này.
  // (customer1/customer2 vẫn dùng được để test các luồng khác.)
