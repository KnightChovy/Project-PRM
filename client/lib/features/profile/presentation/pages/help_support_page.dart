...
/// Help & Support — search, AI chat CTA, FAQ accordion, contact options. All static.
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            for (final (q, a) in _faqs)
              Card(
                ...
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(16),
                  side: BorderSide(color: AppTheme.surfaceVariant.withValues(alpha: 0.5)),
                ),
                clipBehavior: Clip.antiAlias,
                child: ExpansionTile(
                  shape: const Border(),
                  title: Text(q, style: t.bodyLarge?.copyWith(fontWeight: FontWeight.w500)),
            ...
            Center(child: Text('Other ways to reach us', style: t.headlineMedium)),
            const SizedBox(height: 16),
            Row(
              children: const [
                Expanded(child: _ContactTile(icon: Icons.forum_outlined, label: 'Live Chat')),
                SizedBox(width: 16),
                Expanded(child: _ContactTile(icon: Icons.mail_outline, label: 'Email')),
                SizedBox(width: 16),
                Expanded(child: _ContactTile(icon: Icons.call_outlined, label: 'Phone')),
              ],
            ),
