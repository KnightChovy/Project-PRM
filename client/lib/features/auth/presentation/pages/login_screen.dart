...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _onLogin(BuildContext context, AuthNotifier auth) async {
    ...
    if (auth.status == AuthStatus.success) {
      ...
      // Sai email/mật khẩu, tài khoản bị khoá, mất mạng... đều rơi vào đây.
      await showAppErrorDialog(
        context,
        title: 'Login failed',
        message:
            auth.errorMessage ?? 'Unable to sign you in. Please try again.',
      );
    }
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        const Expanded(
                          child: Divider(color: AppColors.goldLight),
                        ),
                        Padding(
